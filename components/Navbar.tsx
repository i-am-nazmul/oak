...
export default function Navbar() {
  ...
  return (
    <motion.nav 
      ...
      className="absolute top-0 left-0 right-0 px-4 sm:px-6 md:px-12 lg:px-20 py-3 md:py-6 flex items-center justify-between bg-transparent z-50"
    >
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <span className="font-serif text-base sm:text-xl md:text-2xl font-medium text-white tracking-widest uppercase">Creators Oak</span>
      </div>

      <div className="hidden lg:flex items-center gap-12">
        <div className="flex items-center gap-8 font-sans text-xl lg:text-2xl font-medium text-white">
          ...
          >
            <div className="flex flex-col px-6 py-6 gap-5 font-medium text-lg">
              ...
              <div className="flex flex-col gap-4 mt-3 border-t border-white/10 pt-5">
                <Link href="#" className="text-center bg-[#dfb871] text-black font-semibold text-lg px-6 py-4 rounded-lg hover:bg-[#c9a55e] transition-colors" onClick={() => setIsMobileMenuOpen(false)}>
                  Let's Connect
                </Link>
              </div>
            </div>
