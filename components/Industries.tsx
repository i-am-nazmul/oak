  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 max-w-7xl mx-auto relative z-10">
      <div className="flex items-center gap-4 mb-8 md:mb-12">
        <span className="text-gold font-playfair text-xl md:text-2xl">3</span>
        <h2 className="text-3xl md:text-5xl font-playfair font-bold text-dark-green">Industries We Serve</h2>
      </div>
